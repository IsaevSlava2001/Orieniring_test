    ...
    public partial class var7 : Form
    {
        ...
        private void timer1_Tick(object sender, EventArgs e)
        {
            ...
            if (minutes == -1)//если все по нулям
            {
                ...
                if (!File.Exists(@"C:\data_orientiring\name\results\7_var"))//если папки данного варианта нет, создаем ее
                {
                    Directory.CreateDirectory(@"C:\data_orientiring\name\results\7_var");
                    File.Create(@"C:\data_orientiring\name\results\7_var\time.txt").Close();//создаем файл для времени
                }
                ...
                button1.Visible = false;
                //------------------------------
                File.WriteAllText(@"C:\data_orientiring\name\results\7_var\time.txt", "600");//говорим, что тест пройден за 10 минут не до конца
        ...
        private void var7_Load(object sender, EventArgs e)
        {
            this.Size = new Size(1556, 864);
            FormBorderStyle = FormBorderStyle.None;this.Size = new Size(1556, 864);
            FormBorderStyle = FormBorderStyle.None;this.Size = new Size(1556, 864);
            ...
            {
                case 1:
                    radioButton1.Text = "Место пересечения";
                    radioButton2.Text = "Финиш";
                    radioButton3.Text = "Контрольный пункт";
                    pictureBox1.Visible = true;
                    break;
                case 2:
                    radioButton1.Text = "Открытое пространство";
                    radioButton2.Text = "Неудобь с редколесьем";
                    radioButton3.Text = "Труднопроходимый лес";
                    pictureBox2.Visible = true;
                    pictureBox1.Visible = false;
                    break;
                case 3:
                    radioButton1.Text = "Преодолимая стена";
                    radioButton2.Text = "Преодолимый трубопровод";
                    radioButton3.Text = "Непреодолимый искусственный линейный объект";
                    pictureBox3.Visible = true;
                    pictureBox2.Visible = false;
                    break;
                case 4:
                    radioButton1.Text = "Тропа";
                    radioButton2.Text = "Заросшая просека";
                    radioButton3.Text = "Просека без тропы, проходимая";
                    pictureBox4.Visible = true;
                    pictureBox3.Visible = false;
                    break;
                case 5:
                    radioButton1.Text = "Строение";
                    radioButton2.Text = "Асфальтированная территория";
                    radioButton3.Text = "Поляна";
                    pictureBox5.Visible = true;
                    pictureBox4.Visible = false;
                    break;
                case 6:
                    radioButton1.Text = "Пересыхающий водный поток";
                    radioButton2.Text = "Канава с водой";
                    radioButton3.Text = "Узкое болото";
                    pictureBox6.Visible = true;
                    pictureBox5.Visible = false;
                    break;
                case 7:
                    radioButton1.Text = "ЛЭП, канатная дорога";
                    radioButton2.Text = "Преодолимый забор";
                    radioButton3.Text = "Железная дорога";
                    pictureBox7.Visible = true;
                    pictureBox6.Visible = false;
                    break;
                case 8:
                    radioButton1.Text = "Каменистый грунт, пробегаемый";
                    radioButton2.Text = "Участок с валунами, медленно пробегаемый";
                    radioButton3.Text = "Микронеровности";
                    pictureBox8.Visible = true;
                    pictureBox7.Visible = false;
                    break;
                case 9:
                    radioButton1.Text = "Камень";
                    radioButton2.Text = "Маленькая башня";
                    radioButton3.Text = "Особый искусственный объект";
                    pictureBox9.Visible = true;
                    pictureBox8.Visible = false;
                    break;
                case 10:
                    radioButton1.Text = "Открытый песок";
                    radioButton2.Text = "Культивируемые поля";
                    radioButton3.Text = "Неудобь";
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            ...
            {
                Directory.CreateDirectory(@"C:\data_orientiring\name\results\7_var");
                File.Create(@"C:\data_orientiring\name\results\7_var\time.txt").Close();
                File.Create(@"C:\data_orientiring\name\results\7_var\1_ans.txt").Close();
                File.Create(@"C:\data_orientiring\name\results\7_var\1_true.txt").Close();
                File.Create(@"C:\data_orientiring\name\results\7_var\2_ans.txt").Close();
                File.Create(@"C:\data_orientiring\name\results\7_var\2_true.txt").Close();
                File.Create(@"C:\data_orientiring\name\results\7_var\3_ans.txt").Close();
                File.Create(@"C:\data_orientiring\name\results\7_var\3_true.txt").Close();
                File.Create(@"C:\data_orientiring\name\results\7_var\4_ans.txt").Close();
                File.Create(@"C:\data_orientiring\name\results\7_var\4_true.txt").Close();
                File.Create(@"C:\data_orientiring\name\results\7_var\5_ans.txt").Close();
                File.Create(@"C:\data_orientiring\name\results\7_var\5_true.txt").Close();
                File.Create(@"C:\data_orientiring\name\results\7_var\6_ans.txt").Close();
                File.Create(@"C:\data_orientiring\name\results\7_var\6_true.txt").Close();
                File.Create(@"C:\data_orientiring\name\results\7_var\7_ans.txt").Close();
                File.Create(@"C:\data_orientiring\name\results\7_var\7_true.txt").Close();
                File.Create(@"C:\data_orientiring\name\results\7_var\8_ans.txt").Close();
                File.Create(@"C:\data_orientiring\name\results\7_var\8_true.txt").Close();
                File.Create(@"C:\data_orientiring\name\results\7_var\9_ans.txt").Close();
                File.Create(@"C:\data_orientiring\name\results\7_var\9_true.txt").Close();
                File.Create(@"C:\data_orientiring\name\results\7_var\10_ans.txt").Close();
                File.Create(@"C:\data_orientiring\name\results\7_var\10_true.txt").Close();
                File.Create(@"C:\data_orientiring\name\results\7_var\complete.txt").Close();

                File.AppendAllText(@"C:\data_orientiring\name\results\7_var\1_true.txt", "2");
                File.AppendAllText(@"C:\data_orientiring\name\results\7_var\2_true.txt", "1");
                File.AppendAllText(@"C:\data_orientiring\name\results\7_var\3_true.txt", "3");
                File.AppendAllText(@"C:\data_orientiring\name\results\7_var\4_true.txt", "1");
                File.AppendAllText(@"C:\data_orientiring\name\results\7_var\5_true.txt", "1");
                File.AppendAllText(@"C:\data_orientiring\name\results\7_var\6_true.txt", "3");
                File.AppendAllText(@"C:\data_orientiring\name\results\7_var\7_true.txt", "2");
                File.AppendAllText(@"C:\data_orientiring\name\results\7_var\8_true.txt", "1");
                File.AppendAllText(@"C:\data_orientiring\name\results\7_var\9_true.txt", "2");
                File.AppendAllText(@"C:\data_orientiring\name\results\7_var\10_true.txt", "3");
            }
            if (n1p == n1r)
            {
                point++;
            ...
            File.AppendAllText(@"C:\data_orientiring\name\results\7_var\time.txt", Convert.ToString(alltime));
            ...
            if (n1p == 4)
            {
                ...
                File.AppendAllText(@"C:\data_orientiring\name\results\7_var\1_ans.txt", "4");
            }
            else
            {
                textBox1.Text = textBox1.Text + "ответили ";
                textBox1.Text = textBox1.Text + n1p;
                File.AppendAllText(@"C:\data_orientiring\name\results\7_var\1_ans.txt", Convert.ToString(n1p));
            }
            ...
            {
                textBox1.Text = textBox1.Text + "пропустили вопрос";
                File.AppendAllText(@"C:\data_orientiring\name\results\7_var\2_ans.txt", "4");
            }
            else
            {
                textBox1.Text = textBox1.Text + "ответили ";
                textBox1.Text = textBox1.Text + n2p;
                File.AppendAllText(@"C:\data_orientiring\name\results\7_var\2_ans.txt", Convert.ToString(n2p));
            }
            textBox1.Text = textBox1.Text + Environment.NewLine+"Правильный ответ ";
            ...
            {
                textBox1.Text = textBox1.Text + "пропустили вопрос";
                File.AppendAllText(@"C:\data_orientiring\name\results\7_var\3_ans.txt", "4");
            }
            else
            {
                textBox1.Text = textBox1.Text + "ответили ";
                textBox1.Text = textBox1.Text + n3p;
                File.AppendAllText(@"C:\data_orientiring\name\results\7_var\3_ans.txt", Convert.ToString(n3p));
            }
            textBox1.Text = textBox1.Text + Environment.NewLine+"Правильный ответ ";
            ...
            {
                textBox1.Text = textBox1.Text + "пропустили вопрос";
                File.AppendAllText(@"C:\data_orientiring\name\results\7_var\4_ans.txt", "4");
            }
            else
            {
                textBox1.Text = textBox1.Text + "ответили ";
                textBox1.Text = textBox1.Text + n4p;
                File.AppendAllText(@"C:\data_orientiring\name\results\7_var\4_ans.txt", Convert.ToString(n4p));
            }
            textBox1.Text = textBox1.Text + Environment.NewLine+"Правильный ответ ";
            ...
            {
                textBox1.Text = textBox1.Text + "пропустили вопрос";
                File.AppendAllText(@"C:\data_orientiring\name\results\7_var\5_ans.txt", "4");
            }
            else
            {
                textBox1.Text = textBox1.Text + "ответили ";
                textBox1.Text = textBox1.Text + n5p;
                File.AppendAllText(@"C:\data_orientiring\name\results\7_var\5_ans.txt", Convert.ToString(n5p));
            }
            textBox1.Text = textBox1.Text + Environment.NewLine+"Правильный ответ ";
            ...
            {
                textBox1.Text = textBox1.Text + "пропустили вопрос";
                File.AppendAllText(@"C:\data_orientiring\name\results\7_var\6_ans.txt", "4");
            }
            else
            {
                textBox1.Text = textBox1.Text + "ответили ";
                textBox1.Text = textBox1.Text + n6p;
                File.AppendAllText(@"C:\data_orientiring\name\results\7_var\6_ans.txt", Convert.ToString(n6p));
            }
            textBox1.Text = textBox1.Text + Environment.NewLine+"Правильный ответ ";
            ...
            {
                textBox1.Text = textBox1.Text + "пропустили вопрос";
                File.AppendAllText(@"C:\data_orientiring\name\results\7_var\7_ans.txt", "4");
            }
            else
            {
                textBox1.Text = textBox1.Text + "ответили ";
                textBox1.Text = textBox1.Text + n7p;
                File.AppendAllText(@"C:\data_orientiring\name\results\7_var\7_ans.txt", Convert.ToString(n7p));
            }
            textBox1.Text = textBox1.Text + Environment.NewLine+"Правильный ответ ";
            ...
            {
                textBox1.Text = textBox1.Text + "пропустили вопрос";
                File.AppendAllText(@"C:\data_orientiring\name\results\7_var\8_ans.txt", "4");
            }
            else
            {
                textBox1.Text = textBox1.Text + "ответили ";
                textBox1.Text = textBox1.Text + n8p;
                File.AppendAllText(@"C:\data_orientiring\name\results\7_var\8_ans.txt", Convert.ToString(n8p));
            }
            textBox1.Text = textBox1.Text + Environment.NewLine+"Правильный ответ ";
            ...
            {
                textBox1.Text = textBox1.Text + "пропустили вопрос";
                File.AppendAllText(@"C:\data_orientiring\name\results\7_var\9_ans.txt", "4");
            }
            else
            {
                textBox1.Text = textBox1.Text + "ответили ";
                textBox1.Text = textBox1.Text + n9p;
                File.AppendAllText(@"C:\data_orientiring\name\results\7_var\9_ans.txt", Convert.ToString(n9p));
            }
            textBox1.Text = textBox1.Text + Environment.NewLine+"Правильный ответ ";
            ...
            {
                textBox1.Text = textBox1.Text + "пропустили вопрос";
                File.AppendAllText(@"C:\data_orientiring\name\results\7_var\10_ans.txt", "4");
            }
            else
            {
                textBox1.Text = textBox1.Text + "ответили ";
                textBox1.Text = textBox1.Text + n10p;
                File.AppendAllText(@"C:\data_orientiring\name\results\7_var\10_ans.txt", Convert.ToString(n10p));
            }
            textBox1.Text = textBox1.Text + Environment.NewLine+"Правильный ответ ";
            ...
            if (n1p == n1r && n2p == n2r && n3p == n3r && n4p == n4r && n5p == n5r && n6p == n6r && n7p == n7r && n8p == n8r && n9p == n9r && n10p == n10r)
            {
                ...
                File.WriteAllText(@"C:\data_orientiring\name\results\7_var\complete.txt", "true");
            }
            else
            {
                File.WriteAllText(@"C:\data_orientiring\name\results\7_var\complete.txt", "false");
                end = true;
            }
        }
