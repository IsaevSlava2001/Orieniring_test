    ...
    public partial class var8 : Form
    {
        ...
        private void timer1_Tick(object sender, EventArgs e)
        {
            ...
            if (minutes == -1)//если все по нулям
            {
                ...
                if (!File.Exists(@"C:\data_orientiring\name\results\8_var"))//если папки данного варианта нет, создаем ее
                {
                    Directory.CreateDirectory(@"C:\data_orientiring\name\results\8_var");
                    File.Create(@"C:\data_orientiring\name\results\8_var\time.txt").Close();//создаем файл для времени
                }
                ...
                button1.Visible = false;
                //------------------------------
                File.WriteAllText(@"C:\data_orientiring\name\results\8_var\time.txt", "600");//говорим, что тест пройден за 10 минут не до конца
        ...
        private void var8_Load(object sender, EventArgs e)
        {
            ...
            switch (numb_test)
            {
                case 1:
                    ...
                    radioButton2.Text = "Непроходимый лес";
                    radioButton3.Text = "Медленнопробегаемый лес";
                    pictureBox1.Visible = true;
                    break;
                case 2:
                    radioButton1.Text = "Контрольный пункт";
                    radioButton2.Text = "Пункт первой помощи";
                    radioButton3.Text = "Пункт питания";
                    pictureBox2.Visible = true;
                    pictureBox1.Visible = false;
                    break;
                case 3:
                    radioButton1.Text = "Мост";
                    radioButton2.Text = "Непроходимые скалы";
                    radioButton3.Text = "Проход в ограде";
                    pictureBox3.Visible = true;
                    pictureBox2.Visible = false;
                    break;
                case 4:
                    radioButton1.Text = "Особый искусственный объект";
                    radioButton2.Text = "Тригонометрический пункт";
                    radioButton3.Text = "Камень";
                    pictureBox4.Visible = true;
                    pictureBox3.Visible = false;
                    break;
                case 5:
                    radioButton1.Text = "Тропа";
                    radioButton2.Text = "Шоссе";
                    radioButton3.Text = "Развалины";
                    pictureBox5.Visible = true;
                    pictureBox4.Visible = false;
                    break;
                case 6:
                    radioButton1.Text = "Неудобь с редколесьем";
                    radioButton2.Text = "Лес, пробегаемый в одном направлении";
                    radioButton3.Text = "Виноградник";
                    pictureBox6.Visible = true;
                    pictureBox5.Visible = false;
                    break;
                case 7:
                    radioButton1.Text = "Высоковольтная ЛЭП";
                    radioButton2.Text = "Непреодолимый забор";
                    radioButton3.Text = "Железная дорога";
                    pictureBox7.Visible = true;
                    pictureBox6.Visible = false;
                    break;
                case 8:
                    radioButton1.Text = "Яма";
                    radioButton2.Text = "Пещера";
                    radioButton3.Text = "Промоина";
                    pictureBox8.Visible = true;
                    pictureBox7.Visible = false;
                    break;
                case 9:
                    radioButton1.Text = "Поле";
                    radioButton2.Text = "Запрещенный район";
                    radioButton3.Text = "Преодолимая ограда";
                    pictureBox9.Visible = true;
                    pictureBox8.Visible = false;
                    break;
                case 10:
                    radioButton1.Text = "Особый объект гидрографии";
                    radioButton2.Text = "Мост";
                    radioButton3.Text = "Место выдачи карт";
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            ...
            {
                Directory.CreateDirectory(@"C:\data_orientiring\name\results\8_var");
                File.Create(@"C:\data_orientiring\name\results\8_var\time.txt").Close();
                File.Create(@"C:\data_orientiring\name\results\8_var\1_ans.txt").Close();
                File.Create(@"C:\data_orientiring\name\results\8_var\1_true.txt").Close();
                File.Create(@"C:\data_orientiring\name\results\8_var\2_ans.txt").Close();
                File.Create(@"C:\data_orientiring\name\results\8_var\2_true.txt").Close();
                File.Create(@"C:\data_orientiring\name\results\8_var\3_ans.txt").Close();
                File.Create(@"C:\data_orientiring\name\results\8_var\3_true.txt").Close();
                File.Create(@"C:\data_orientiring\name\results\8_var\4_ans.txt").Close();
                File.Create(@"C:\data_orientiring\name\results\8_var\4_true.txt").Close();
                File.Create(@"C:\data_orientiring\name\results\8_var\5_ans.txt").Close();
                File.Create(@"C:\data_orientiring\name\results\8_var\5_true.txt").Close();
                File.Create(@"C:\data_orientiring\name\results\8_var\6_ans.txt").Close();
                File.Create(@"C:\data_orientiring\name\results\8_var\6_true.txt").Close();
                File.Create(@"C:\data_orientiring\name\results\8_var\7_ans.txt").Close();
                File.Create(@"C:\data_orientiring\name\results\8_var\7_true.txt").Close();
                File.Create(@"C:\data_orientiring\name\results\8_var\8_ans.txt").Close();
                File.Create(@"C:\data_orientiring\name\results\8_var\8_true.txt").Close();
                File.Create(@"C:\data_orientiring\name\results\8_var\9_ans.txt").Close();
                File.Create(@"C:\data_orientiring\name\results\8_var\9_true.txt").Close();
                File.Create(@"C:\data_orientiring\name\results\8_var\10_ans.txt").Close();
                File.Create(@"C:\data_orientiring\name\results\8_var\10_true.txt").Close();
                File.Create(@"C:\data_orientiring\name\results\8_var\complete.txt").Close();

                File.AppendAllText(@"C:\data_orientiring\name\results\8_var\1_true.txt", "2");
                File.AppendAllText(@"C:\data_orientiring\name\results\8_var\2_true.txt", "1");
                File.AppendAllText(@"C:\data_orientiring\name\results\8_var\3_true.txt", "3");
                File.AppendAllText(@"C:\data_orientiring\name\results\8_var\4_true.txt", "1");
                File.AppendAllText(@"C:\data_orientiring\name\results\8_var\5_true.txt", "1");
                File.AppendAllText(@"C:\data_orientiring\name\results\8_var\6_true.txt", "3");
                File.AppendAllText(@"C:\data_orientiring\name\results\8_var\7_true.txt", "2");
                File.AppendAllText(@"C:\data_orientiring\name\results\8_var\8_true.txt", "1");
                File.AppendAllText(@"C:\data_orientiring\name\results\8_var\9_true.txt", "2");
                File.AppendAllText(@"C:\data_orientiring\name\results\8_var\10_true.txt", "3");
            }
            if (n1p == n1r)
            {
                point++;
            ...
            if (n1p == n1r && n2p == n2r && n3p == n3r && n4p == n4r && n5p == n5r && n6p == n6r && n7p == n7r && n8p == n8r && n9p == n9r && n10p == n10r)
            {
                ...
                File.WriteAllText(@"C:\data_orientiring\name\results\8_var\complete.txt", "true");
            }
            else
            {
                File.WriteAllText(@"C:\data_orientiring\name\results\8_var\complete.txt", "false");
                end = true;
            }
        }
