...
{
    public partial class _2_var : Form
    {
        ...
        private void _2_var_Load(object sender, EventArgs e)
        {
            ...
            {
                case 1:
                    radioButton1.Text = "Преодолимый водный поток, шириной более 2 метров";
                    radioButton2.Text = "узкое болото";
                    radioButton3.Text = "Узкая заросшая просека";
                    pictureBox1.Visible = true;
                    break;
                case 2:
                    radioButton1.Text = "Ямы";
                    radioButton2.Text = "Микронеровности";
                    radioButton3.Text = "Холмы";
                    pictureBox2.Visible = true;
                    pictureBox1.Visible = false;
                    break;
                case 3:
                    radioButton1.Text = "Непреодолимая скала";
                    radioButton2.Text = "Грунтовый обрыв";
                    radioButton3.Text = "утолщенная горизонталь";
                    pictureBox3.Visible = true;
                    pictureBox2.Visible = false;
                    break;
                case 4:
                    radioButton1.Text = "Непреодолимый водоем";
                    radioButton2.Text = "Запрещенная территория";
                    radioButton3.Text = "Непреодолимое болото";
                    pictureBox4.Visible = true;
                    pictureBox3.Visible = false;
                    break;
                case 5:
                    radioButton1.Text = "Пересыхающий водный поток";
                    radioButton2.Text = "Тропа";
                ...
                case 6:
                    ...
                    radioButton2.Text = "Каменистая траншея";
                    radioButton3.Text = "ЛЭП";
                    pictureBox6.Visible = true;
                    pictureBox5.Visible = false;
                    break;
                case 7:
                    radioButton1.Text = "Каменистый грунт, медленно преодолеваемый";
                    radioButton2.Text = "Открытый песок";
                    radioButton3.Text = "Неровный грунт";
                    pictureBox7.Visible = true;
                    pictureBox6.Visible = false;
                    break;
                case 8:
                    radioButton1.Text = "Финиш";
                    radioButton2.Text = "Точка начала ориентирования";
                    radioButton3.Text = "Особый объект рельефа";
                    pictureBox8.Visible = true;
                    pictureBox7.Visible = false;
                    break;
                case 9:
                    radioButton1.Text = "Легкопробегаемый лес";
                    radioButton2.Text = "Подлесок, медленно пробегаемый";
                    radioButton3.Text = "Лес, позволяющий идти";
                    pictureBox9.Visible = true;
                    pictureBox8.Visible = false;
                    break;
                case 10:
                    radioButton1.Text = "Каменная стена";
                    radioButton2.Text = "ЛЭП";
                    radioButton3.Text = "Непроходимая ограда";
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            ...
            {
                Directory.CreateDirectory(@"C:\data_orientiring\name\results\2_var");
                File.Create(@"C:\data_orientiring\name\results\2_var\time.txt").Close();
                File.Create(@"C:\data_orientiring\name\results\2_var\1_ans.txt").Close();
                File.Create(@"C:\data_orientiring\name\results\2_var\1_true.txt").Close();
                File.Create(@"C:\data_orientiring\name\results\2_var\2_ans.txt").Close();
                File.Create(@"C:\data_orientiring\name\results\2_var\2_true.txt").Close();
                File.Create(@"C:\data_orientiring\name\results\2_var\3_ans.txt").Close();
                File.Create(@"C:\data_orientiring\name\results\2_var\3_true.txt").Close();
                File.Create(@"C:\data_orientiring\name\results\2_var\4_ans.txt").Close();
                File.Create(@"C:\data_orientiring\name\results\2_var\4_true.txt").Close();
                File.Create(@"C:\data_orientiring\name\results\2_var\5_ans.txt").Close();
                File.Create(@"C:\data_orientiring\name\results\2_var\5_true.txt").Close();
                File.Create(@"C:\data_orientiring\name\results\2_var\6_ans.txt").Close();
                File.Create(@"C:\data_orientiring\name\results\2_var\6_true.txt").Close();
                File.Create(@"C:\data_orientiring\name\results\2_var\7_ans.txt").Close();
                File.Create(@"C:\data_orientiring\name\results\2_var\7_true.txt").Close();
                File.Create(@"C:\data_orientiring\name\results\2_var\8_ans.txt").Close();
                File.Create(@"C:\data_orientiring\name\results\2_var\8_true.txt").Close();
                File.Create(@"C:\data_orientiring\name\results\2_var\9_ans.txt").Close();
                File.Create(@"C:\data_orientiring\name\results\2_var\9_true.txt").Close();
                File.Create(@"C:\data_orientiring\name\results\2_var\10_ans.txt").Close();
                File.Create(@"C:\data_orientiring\name\results\2_var\10_true.txt").Close();
                File.Create(@"C:\data_orientiring\name\results\2_var\complete.txt").Close();

                File.AppendAllText(@"C:\data_orientiring\name\results\2_var\1_true.txt", "1");
                File.AppendAllText(@"C:\data_orientiring\name\results\2_var\2_true.txt", "3");
                File.AppendAllText(@"C:\data_orientiring\name\results\2_var\3_true.txt", "2");
                File.AppendAllText(@"C:\data_orientiring\name\results\2_var\4_true.txt", "1");
                File.AppendAllText(@"C:\data_orientiring\name\results\2_var\5_true.txt", "1");
                File.AppendAllText(@"C:\data_orientiring\name\results\2_var\6_true.txt", "2");
                File.AppendAllText(@"C:\data_orientiring\name\results\2_var\7_true.txt", "3");
                File.AppendAllText(@"C:\data_orientiring\name\results\2_var\8_true.txt", "2");
                File.AppendAllText(@"C:\data_orientiring\name\results\2_var\9_true.txt", "2");
                File.AppendAllText(@"C:\data_orientiring\name\results\2_var\10_true.txt", "3");
            }
            if(n1p==n1r)
            {
                point++;
            ...
            timer1.Stop();
                ...
                File.AppendAllText(@"C:\data_orientiring\name\results\2_var\time.txt", Convert.ToString(alltime));
            ...
            else if (pre_last == "1")
            {
                ...
                if (n1p == 4)
                {
                    ...
                    File.AppendAllText(@"C:\data_orientiring\name\results\2_var\1_ans.txt", "4");
                }
                else
                {
                    textBox1.Text = textBox1.Text + "ответили ";
                    textBox1.Text = textBox1.Text + n1p;
                    File.AppendAllText(@"C:\data_orientiring\name\results\2_var\1_ans.txt", Convert.ToString(n1p));
                }
                ...
                {
                    textBox1.Text = textBox1.Text + "пропустили вопрос";
                    File.AppendAllText(@"C:\data_orientiring\name\results\2_var\2_ans.txt", "4");
                }
                else
                {
                    textBox1.Text = textBox1.Text + "ответили ";
                    textBox1.Text = textBox1.Text + n2p;
                    File.AppendAllText(@"C:\data_orientiring\name\results\2_var\2_ans.txt", Convert.ToString(n2p));
                }
                textBox1.Text = textBox1.Text + Environment.NewLine + "Правильный ответ ";
                ...
                {
                    textBox1.Text = textBox1.Text + "пропустили вопрос";
                    File.AppendAllText(@"C:\data_orientiring\name\results\2_var\3_ans.txt", "4");
                }
                else
                {
                    textBox1.Text = textBox1.Text + "ответили ";
                    textBox1.Text = textBox1.Text + n3p;
                    File.AppendAllText(@"C:\data_orientiring\name\results\2_var\3_ans.txt", Convert.ToString(n3p));
                }
                textBox1.Text = textBox1.Text + Environment.NewLine + "Правильный ответ ";
                ...
                {
                    textBox1.Text = textBox1.Text + "пропустили вопрос";
                    File.AppendAllText(@"C:\data_orientiring\name\results\2_var\4_ans.txt", "4");
                }
                else
                {
                    textBox1.Text = textBox1.Text + "ответили ";
                    textBox1.Text = textBox1.Text + n4p;
                    File.AppendAllText(@"C:\data_orientiring\name\results\2_var\4_ans.txt", Convert.ToString(n4p));
                }
                textBox1.Text = textBox1.Text + Environment.NewLine + "Правильный ответ ";
                ...
                {
                    textBox1.Text = textBox1.Text + "пропустили вопрос";
                    File.AppendAllText(@"C:\data_orientiring\name\results\2_var\5_ans.txt", "4");
                }
                else
                {
                    textBox1.Text = textBox1.Text + "ответили ";
                    textBox1.Text = textBox1.Text + n5p;
                    File.AppendAllText(@"C:\data_orientiring\name\results\2_var\5_ans.txt", Convert.ToString(n5p));
                }
                textBox1.Text = textBox1.Text + Environment.NewLine + "Правильный ответ ";
                ...
                {
                    textBox1.Text = textBox1.Text + "пропустили вопрос";
                    File.AppendAllText(@"C:\data_orientiring\name\results\2_var\6_ans.txt", "4");
                }
                else
                {
                    textBox1.Text = textBox1.Text + "ответили ";
                    textBox1.Text = textBox1.Text + n6p;
                    File.AppendAllText(@"C:\data_orientiring\name\results\2_var\6_ans.txt", Convert.ToString(n6p));
                }
                textBox1.Text = textBox1.Text + Environment.NewLine + "Правильный ответ ";
                ...
                {
                    textBox1.Text = textBox1.Text + "пропустили вопрос";
                    File.AppendAllText(@"C:\data_orientiring\name\results\2_var\7_ans.txt", "4");
                }
                else
                {
                    textBox1.Text = textBox1.Text + "ответили ";
                    textBox1.Text = textBox1.Text + n7p;
                    File.AppendAllText(@"C:\data_orientiring\name\results\2_var\7_ans.txt", Convert.ToString(n7p));
                }
                textBox1.Text = textBox1.Text + Environment.NewLine + "Правильный ответ ";
                ...
                {
                    textBox1.Text = textBox1.Text + "пропустили вопрос";
                    File.AppendAllText(@"C:\data_orientiring\name\results\2_var\8_ans.txt", "4");
                }
                else
                {
                    textBox1.Text = textBox1.Text + "ответили ";
                    textBox1.Text = textBox1.Text + n8p;
                    File.AppendAllText(@"C:\data_orientiring\name\results\2_var\8_ans.txt", Convert.ToString(n8p));
                }
                textBox1.Text = textBox1.Text + Environment.NewLine + "Правильный ответ ";
                ...
                {
                    textBox1.Text = textBox1.Text + "пропустили вопрос";
                    File.AppendAllText(@"C:\data_orientiring\name\results\2_var\9_ans.txt", "4");
                }
                else
                {
                    textBox1.Text = textBox1.Text + "ответили ";
                    textBox1.Text = textBox1.Text + n9p;
                    File.AppendAllText(@"C:\data_orientiring\name\results\2_var\9_ans.txt", Convert.ToString(n9p));
                }
                textBox1.Text = textBox1.Text + Environment.NewLine + "Правильный ответ ";
                ...
                {
                    textBox1.Text = textBox1.Text + "пропустили вопрос";
                    File.AppendAllText(@"C:\data_orientiring\name\results\2_var\10_ans.txt", "4");
                }
                else
                {
                    textBox1.Text = textBox1.Text + "ответили ";
                    textBox1.Text = textBox1.Text + n10p;
                    File.AppendAllText(@"C:\data_orientiring\name\results\2_var\10_ans.txt", Convert.ToString(n10p));
                }
                textBox1.Text = textBox1.Text + Environment.NewLine + "Правильный ответ ";
            ...
            button2.Visible = false;
                if (n1p == n1r && n2p == n2r && n3p == n3r && n4p == n4r && n5p == n5r && n6p == n6r && n7p == n7r && n8p == n8r && n9p == n9r && n10p == n10r)
                {
                    ...
                    File.WriteAllText(@"C:\data_orientiring\name\results\2_var\complete.txt", "true");
                }
                else
                {
                    File.WriteAllText(@"C:\data_orientiring\name\results\2_var\complete.txt", "false");
                    end = true;
                }
            }
        }
